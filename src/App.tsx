...
import type { EventFormState, GameEvent, ProjectSettings as ProjectSettingsType } from './types';
import './App.css';
    ...
    <div className="layout">
      ...
      <main className="content-grid">
        ...
        <div className="sidebar">
          ...
          <EventExport events={sortedEvents} settings={projectSettings} onImport={handleImport} />
        </div>
      </main>
