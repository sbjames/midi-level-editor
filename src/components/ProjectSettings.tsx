import { DEFAULT_PROJECT_SETTINGS, GAME_EVENT_CHANNEL } from '../constants';
    ...
    <section className="panel">
      ...
      <div className="form-grid">
        ...
        <label className="form-field">
          ...
          <input type="number" value={GAME_EVENT_CHANNEL} readOnly disabled />
          <small>Game events are written to channel 15 on the merged MIDI file.</small>
        </label>
      </div>
    </section>
  );
